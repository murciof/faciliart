class ArtsController < ApplicationController
  ...
  GENERATORS = [{ generator: 'line',
                  description: 'Lines with random points',
                  sliders: [{ element: 'points', min: '2', max: '100', value: '50' }] },
                { generator: 'curve',
                  description: 'Curves with random points',
                  sliders: [{ element: 'points', min: '4', max: '100', value: '50' }] },
                { generator: 'polygon', description: 'Polygon with random points',
                  sliders: [{ element: 'points', min: '3', max: '100', value: '50' }] },
                { generator: 'static circles',
                  description: 'Random circles positioning with static dimensions',
                  sliders: [{ element: 'points', min: '1', max: '100', value: '50' },
                            { element: 'diameter', min: '1', max: '100', value: '10' }] },
                { generator: 'static ellipses',
                  description: 'Random ellipses positioning with static dimensions',
                  sliders: [{ element: 'points', min: '1', max: '100', value: '50' },
                            { element: 'width', min: '1', max: '100', value: '10' },
                            { element: 'height', min: '1', max: '100', value: '10' }] },
                { generator: 'static squares',
                  description: 'Random squares positioning with static dimensions',
                  sliders: [{ element: 'points', min: '1', max: '100', value: '50' },
                            { element: 'size', min: '1', max: '100', value: '10' }] },
                { generator: 'static rectangles',
                  description: 'Random rectangles positioning with static dimensions',
                  sliders: [{ element: 'points', min: '1', max: '100', value: '50' },
                            { element: 'width', min: '1', max: '100', value: '10' },
                            { element: 'height', min: '1', max: '100', value: '10' }] },
                { generator: 'dynamic circles',
                  description: 'Random circles positioning with random dimensions',
                  sliders: [{ element: 'points', min: '1', max: '100', value: '50' },
                            { element: 'limit', min: '1', max: '100', value: '10' }] },
                { generator: 'dynamic ellipses',
                  description: 'Random ellipses positioning with random dimensions',
                  sliders: [{ element: 'points', min: '1', max: '100', value: '50' },
                            { element: 'limit', min: '1', max: '100', value: '10' }] },
                { generator: 'dynamic squares',
                  description: 'Random squares positioning with random dimensions',
                  sliders: [{ element: 'points', min: '1', max: '100', value: '50' },
                            { element: 'limit', min: '1', max: '100', value: '10' }] },
                { generator: 'dynamic rectangles',
                  description: 'Random rectangles positioning with random dimensions',
                  sliders: [{ element: 'points', min: '1', max: '100', value: '50' },
                            { element: 'limit', min: '1', max: '100', value: '10' }] },
                { generator: 'animated circles',
                  description: 'EXPERIMENTAL: Random circles positioning with animated dimensions',
                  sliders: [{ element: 'points', min: '1', max: '100', value: '50' },
                            { element: 'limit', min: '1', max: '100', value: '10' }] },
                { generator: 'animated ellipses',
                  description: 'EXPERIMENTAL: Random ellipses positioning with animated dimensions',
                  sliders: [{ element: 'points', min: '1', max: '100', value: '50' },
                            { element: 'limit', min: '1', max: '100', value: '10' }] },
                { generator: 'animated squares',
                  description: 'EXPERIMENTAL: Random squares positioning with animated dimensions',
                  sliders: [{ element: 'points', min: '1', max: '100', value: '50' },
                            { element: 'limit', min: '1', max: '100', value: '10' }] },
                { generator: 'animated rectangles',
                  description: 'EXPERIMENTAL: Random rectangles positioning with animated dimensions',
                  sliders: [{ element: 'points', min: '1', max: '100', value: '50' },
